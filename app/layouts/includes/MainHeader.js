            ...
            <div id="MainHeader" className="border-b">
                <nav className="flex items-center justify-between w-full mx-auto max-w-[1200px]">
                    <div className="flex items-center w-full bg-white">
                        <div className="flex items-center lg:justify-start justify-between gap-10 max-w-[1150px] w-full px-3 py-5 mx-auto">
                            <Link href="/">
                                <img width="120" src="/imgs/logo.webp" />
                            </Link>
                                                    ...
                                                    {items.map((item) => (
                                                        <div className="p-1" key={item.id}>
                                                            ...
                                                            >
                                                                ...
                                                                <div className="truncate">MAD { (item?.price / 100).toFixed(2) }</div>
                                                            </Link>
                                                        </div>
                                                    ))}
                                                </div>
